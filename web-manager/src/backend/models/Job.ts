...
const JobSchema = new Schema<IJob>(
  {
    ...
    cv_id: { type: String, default: null },
    ...
    motivation_email_draft_url: { type: String, default: null },
    motivation_email_subject: { type: String, default: null },
    motivation_email_to: { type: String, default: null },
    original_job_id: { type: String, default: null },
    original_mail_id: { type: String, default: null },
    outdated: { type: Boolean, default: false },
    outdated_reason: { type: String, default: null },
    outdated_date: { type: Date, default: null },
    preference: { type: String, default: null },
    processing_stage: { type: String, default: null },
