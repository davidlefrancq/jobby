...
export default function JobExplorerCard({ job }: JobExplorerCardProps) {
  ...
  return (
    ...
    <div
      className="w-full bg-white border border-gray-200 shadow-2xs rounded-xl dark:bg-neutral-900 dark:border-neutral-700 dark:shadow-neutral-700/70"
    >
      {/* Card Header */}
      ...
      <div className="p-4">
        ...
        {/* Bottom bar */}
        <div className="flex gap-2 justify-center items-center text-gray-500 dark:text-neutral-400">
